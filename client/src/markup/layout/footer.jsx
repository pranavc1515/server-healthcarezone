              ...
              <div className="row">
                    ...
                    <div className="ft-contact">
                      ...
                      <div className="contact-bx">
                        ...
                        <div className="contact-number">
                          ...
                          <h4 className="number">+91 8888073108</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-xl-3 col-lg-3 col-6">
                  <div className="widget footer_widget">
                    ...
                    <ul>
                      <li>
                        <Link to="/service/hospital">
                          <span>Hospital</span>
                        </Link>
                      </li>
                      <li>
                        <Link to="/service/medical">
                          <span>Medical</span>
                        </Link>
                      </li>
                      <li>
                        <Link to="/service/pathological-laboratories">
                          <span>Pathological Laboratories</span>
                        </Link>
                      </li>
                      <li>
